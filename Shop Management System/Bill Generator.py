...
class Bill_App :
    def __init__(self, master):
        ...
        title = Label(self.master, text="SHOP MANAGEMENT", bd=12, relief=GROOVE, bg="#F68D22",
        ...
        F0 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Customer Details",
                        font=("times new roman", 15, "bold"), fg="gold", bg="#4F4581")
        F0.place(x=0, y=70, width=950)

        cname_label = Label(F0, text="Customer Name", bg="#5997AC", font=("times new romen", 18, "bold")).grid(row=0,
                                                                                                                column=0,
                                                                                                                padx=20,
                                                                                                                pady=5)
        ...
        cphn_label = Label(F0, text="Phone No.", bg="#5997AC", font=("times new romen", 18, "bold")).grid(row=0,
                                                                                                           column=2,
                                                                                                           padx=20,
                                                                                                           pady=5)
        ...
        F1 = LabelFrame(self.master, bd=10, relief=GROOVE, text="send bill via Email ",
                        font=("times new roman", 15, "bold"), fg="gold", bg="#5997AC")
        F1.place(x=950, y=70, width=587)

        cmail_label = Label(F1, text="Email", bg="#5997AC", font=("times new romen", 18, "bold")).grid(row=0, column=4,
                                                                                                        padx=20, pady=5)
        ...
        send_btn = Button(F1, text="Send", bg="cyan", bd=5, fg="black", width=8, font="arial 12 bold").grid(row=0,
                                                                                                            column=7)  # enter this line :- command=self.check_mail

        # ----------------->>>>> COsmetic frame <<<----------------
        F2 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Cosmetic", font=("times new roman", 15, "bold"),
                        fg="gold", bg="#5997AC")
        F2.place(x=5, y=152, width=277, height=393)

        bath_txt = Entry(F2, width=2, textvariable=self.soap, font=("times new roman", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10, sticky=W)
        bath_label = Label(F2, text="Bath Soap", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        # face cream
        facecream_label = Label(F2, text="Face Cream", font=("times new roman", 16, "bold"), fg="black",
                                bg="#5997AC").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        facecream_txt = Entry(F2, width=2, textvariable=self.facecream, font=("times new roman", 16, "bold"), bd=5,
                              relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10, sticky=W)

        # Facewash
        facewash_label = Label(F2, text="Facewash", font=("times new roman", 16, "bold"), fg="black",
                               bg="#5997AC").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        facewash_txt = Entry(F2, width=2, textvariable=self.facewash, font=("times new roman", 16, "bold"), bd=5,
                             relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10, sticky=W)

        # hair spray
        hair_Spry_label = Label(F2, text="Hair Spray", font=("times new roman", 16, "bold"), fg="black",
                                bg="#5997AC").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        hair_spry_txt = Entry(F2, width=2, textvariable=self.hair_spry, font=("times new roman", 16, "bold"), bd=5,
                              relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        # Hair gel
        hair_gel_label = Label(F2, text="Hair Gel", font=("times new roman", 16, "bold"), fg="black",
                               bg="#5997AC").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        hair_gel_txt = Entry(F2, width=2, textvariable=self.hair_gel, font=("times new roman", 16, "bold"), bd=5,
                             relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10, sticky=W)

        # bodylotion
        body_lt_label = Label(F2, text="Body Lotion", font=("times new roman", 16, "bold"), fg="black",
                              bg="#5997AC").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        body_lt_txt = Entry(F2, width=2, textvariable=self.body_lotion, font=("times new roman", 16, "bold"), bd=5,
        ...
        # ----------------->>>>> Groccery frame <<<----------------
        F3 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Grocery", font=("times new roman", 15, "bold"),
                        fg="gold", bg="#5997AC")
        F3.place(x=276, y=152, width=220, height=393)

        g1_label = Label(F3, text="Meggie", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=0,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        ...
        g2_label = Label(F3, text="Rice", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=1,
                                                                                                                column=0,
                                                                                                                padx=10,
                                                                                                                pady=10,
                                                                                                                sticky="w")
        ...
        g3_label = Label(F3, text="Wheat", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=2,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        ...
        g4_label = Label(F3, text="Food oil", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        g4_txt = Entry(F3, width=4, textvariable=self.food_oil, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        g5_label = Label(F3, text="Daal", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=4,
                                                                                                                column=0,
                                                                                                                padx=10,
                                                                                                                pady=10,
                                                                                                                sticky="w")
        ...
        g6_label = Label(F3, text="Sugar", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=5,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        ...
        # ----------------->>>>> cold-drink frame <<<----------------
        F4 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Cold Drink", font=("times new roman", 15, "bold"),
                        fg="gold", bg="#5997AC")
        F4.place(x=490, y=152, width=220, height=393)

        c1_label = Label(F4, text="Maza", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=0,
                                                                                                                column=0,
                                                                                                                padx=10,
                                                                                                                pady=10,
                                                                                                                sticky="w")
        c1_txt = Entry(F4, width=4, textvariable=self.maza, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10, sticky=W)

        c2_label = Label(F4, text="Coca cola", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=1, column=0, padx=10, pady=10, sticky="w")
        c2_txt = Entry(F4, width=4, textvariable=self.coca_cola, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10, sticky=W)

        c3_label = Label(F4, text="Thumbs-up", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=2, column=0, padx=10, pady=10, sticky="w")
        c3_txt = Entry(F4, width=4, textvariable=self.thumbs_up, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10, sticky=W)

        c4_label = Label(F4, text="Slice", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=3,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        c4_txt = Entry(F4, width=4, textvariable=self.slice, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        c5_label = Label(F4, text="Frooti", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=4,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        c5_txt = Entry(F4, width=4, textvariable=self.frooti, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10, sticky=W)

        c6_label = Label(F4, text="Pepsi", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=5,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        c6_txt = Entry(F4, width=4, textvariable=self.pepsi, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10, sticky=W)

        # ----------------->>>>> Biscuit frame <<<----------------
        F4 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Biscuits", font=("times new roman", 15, "bold"),
                        fg="gold", bg="#5997AC")
        F4.place(x=705, y=152, width=230, height=393)

        c1_label = Label(F4, text="Parle-G", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        c1_txt = Entry(F4, width=4, textvariable=self.parle, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10, sticky=W)

        c2_label = Label(F4, text="Britania", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=1, column=0, padx=10, pady=10, sticky="w")
        c2_txt = Entry(F4, width=4, textvariable=self.britania, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10, sticky=W)

        c3_label = Label(F4, text="Oreo", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=2,
                                                                                                                column=0,
                                                                                                                padx=10,
                                                                                                                pady=10,
                                                                                                                sticky="w")
        c3_txt = Entry(F4, width=4, textvariable=self.oreo, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10, sticky=W)

        c4_label = Label(F4, text="Good Day", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        c4_txt = Entry(F4, width=4, textvariable=self.goodday, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        c5_label = Label(F4, text="Sunfist", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        c5_txt = Entry(F4, width=4, textvariable=self.sunfist, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10, sticky=W)

        c6_label = Label(F4, text="Monaco", font=("times new roman", 16, "bold"), fg="black", bg="#5997AC").grid(row=5,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        c6_txt = Entry(F4, width=4, textvariable=self.monaco, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10, sticky=W)
        ...
        m1 = Label(F7, text="Total Cosmetic Price", bg="#5997AC", fg="black",
                   font=("times new roman", 14, "bold")).grid(row=0, column=0, padx=20, pady=1, sticky=W)
        ml_txt = Entry(F7, width=18, textvariable=self.cosmetic_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=1, padx=10, pady=1)

        m2 = Label(F7, text="Total Grocery Price", bg="#5997AC", fg="black",
        ...
        m3 = Label(F7, text="Total Cold-drink Price", bg="#5997AC", fg="black",
        ...
        m4 = Label(F7, text="Total Biscuit Price", bg="#5997AC", fg="black",
                   font=("times new roman", 14, "bold")).grid(row=3, column=0, padx=20, pady=1, sticky=W)
        m4_txt = Entry(F7, width=18, textvariable=self.biscuit_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=3, column=1, padx=10, pady=1)

        # for tax

        tax1 = Label(F7, text="Cosmetic Tax (28%)", bg="#5997AC", fg="black",
                     font=("times new roman", 14, "bold")).grid(row=0, column=2, padx=20, pady=1, sticky=W)
        taxl_txt = Entry(F7, width=18, textvariable=self.cosmetic_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=3, padx=10, pady=1)

        tax2 = Label(F7, text="Grocery Tax (5%)", bg="#5997AC", fg="black", font=("times new roman", 14, "bold")).grid(
            row=1, column=2, padx=20, pady=1, sticky=W)
        tax2_txt = Entry(F7, width=18, textvariable=self.grocery_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=1, column=3, padx=10, pady=1)

        tax3 = Label(F7, text="Cold-drink Tax (40%)", bg="#5997AC", fg="black",
                     font=("times new roman", 14, "bold")).grid(row=2, column=2, padx=20, pady=1, sticky=W)
        tax3_txt = Entry(F7, width=18, textvariable=self.cold_drink_tax, font="arial 10 bold", bd=7,
                         relief=SUNKEN).grid(row=2, column=3, padx=10, pady=1)

        tax4 = Label(F7, text="Biscuit Tax (5%)", bg="#5997AC", fg="black", font=("times new roman", 14, "bold")).grid(
            row=3, column=2, padx=20, pady=1, sticky=W)
        tax4_txt = Entry(F7, width=18, textvariable=self.biscuit_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
        ...
        genbill_btn = Button(btn_frame, text="Generate Bill", command=self.bill_area, bg="cyan", bd=5, fg="black",
                             pady=15, width=14, font="arial 12 bold").grid(row=0, column=1, padx=15, pady=15)

        clear_btn = Button(btn_frame, text="Clear", command=self.clear_data, bg="cyan", bd=5, fg="black", pady=15,
                           width=11, font="arial 12 bold").grid(row=0, column=2, padx=15, pady=15)

        exit_btn = Button(btn_frame, text="Exit", command=self.exit_app, bg="cyan", bd=5, fg="black", pady=15, width=11,
                          font="arial 12 bold").grid(row=0, column=3, padx=15, pady=15)

        self.welcome_bill()
        # ----------------->>>>> bill search frame <<<----------------
        F8 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Bill Search ", font=("times new roman", 15, "bold"),
                        fg="gold", bg="tomato")
        F8.place(x=0, y=712, width=350, height=80)

        bn_txt = Entry(F8, width=18, textvariable=self.search_bill, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=1, padx=30, pady=1)
        search_btn = Button(F8, text="Search", command=self.find_bill, bg="cyan", bd=5, fg="black", width=8,
                            font="arial 12 bold").grid(row=0, column=2)

        # ---------------Admin area-----------------------
        F9 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Admin area ", font=("times new roman", 15, "bold"),
                        fg="gold", bg="tomato")
        F9.place(x=351, y=712, width=1186, height=80)

        Label(F9, text="Login :  | ", font=("times new roman", 15, "bold"), fg="black", bg="sky blue").grid(row=0,
                                                                                                            column=0)
        Label(F9, text="ID ", font=("times new roman", 15, "bold"), fg="black", bg="tomato").grid(row=0, column=1)

        admin_id1 = Entry(F9, width=25, textvariable=self.admin_id, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=2, sticky=E)

        Label(F9, text="  Password", font=("times new roman", 15, "bold"), fg="black", bg="#5997AC").grid(row=0,
                                                                                                           column=3)
        ...
        # -------sign up----------------
        Label(F9, text="  Create New Account", font=("times new roman", 15, "bold"), fg="black", bg="#5997AC").grid(
            row=0, column=6)
        a_sign_up = Button(F9, text="Sign Up", bg="cyan", bd=5, fg="black", width=12, font="arial 12 bold").grid(row=0,
                                                                                                                 column=7,
                                                                                                                 padx=35)

    def image_section(self):
        img = Image.open("shopping3.jpg")
        pic = ImageTk.PhotoImage(img)
        F5 = LabelFrame(self.master, bd=10, relief=GROOVE, bg="#5997AC")
...
class login_page_window :
    def __init__(self, master1):
        ...
        title = Label(self.master1, text="CRP SHOP MANAGEMENT", bd=12, relief=GROOVE, bg="#5997AC",
                      font=("times new roman", 30, "bold"), pady=2).pack(fill=X)
        ...
        F1 = LabelFrame(self.master1, bd=10, relief=GROOVE, text="MENU", font=("times new roman", 15, "bold"),
                        fg="black", bg="#5997AC")
        F1.place(x=0, y=133, width=230, height=600)

        today_sell = Button(F1, text="Today's Sell", bg="cyan", bd=5, fg="black", width=15, font="arial 12 bold").grid(
            row=0, column=0, padx=10, pady=15)

        total_sell = Button(F1, text="Total Sell", bg="cyan", bd=5, fg="black", width=15, font="arial 12 bold").grid(
            row=1, column=0, padx=10, pady=15)

        stock = Button(F1, text="Stock", command=self.check_stock, bg="cyan", bd=5, fg="black", width=15,
                       font="arial 12 bold").grid(row=2, column=0, padx=10, pady=15)

        update_stock = Button(F1, text="Update Stock", command=self.Update_stock, bg="cyan", bd=5, fg="black", width=15,
                              font="arial 12 bold").grid(row=3, column=0, padx=10, pady=15)

        change_password = Button(F1, text="Change password", bg="cyan", bd=5, fg="black", width=15,
                                 font="arial 12 bold").grid(row=4, column=0, padx=10, pady=15)

        lis_of_bill = Button(F1, text="Bill List", command=self.bill_list, bg="cyan", bd=5, fg="black", width=15,
                             font="arial 12 bold").grid(row=5, column=0, padx=10, pady=15)

        clear = Button(F1, text="Clear", command=self.clear_admin_notebook, bg="cyan", bd=5, fg="black", width=15,
                       font="arial 12 bold").grid(row=6, column=0, padx=10, pady=15)

        F3 = LabelFrame(self.master1, bd=10, text="Bottom", relief=GROOVE, bg="#5997AC")
        ...
        # ---------------------------------------------
        F2 = LabelFrame(self.master1, bd=10, relief=GROOVE, bg="#5997AC")
